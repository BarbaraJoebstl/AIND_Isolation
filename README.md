...
## Starter Code
The starter code is provided by [Udacity AIND](https://github.com/udacity/AIND-Isolation)
...
### Useful links
- [AIMA Minimax Decision](https://github.com/aimacode/aima-pseudocode/blob/master/md/Minimax-Decision.md)
- [AIMA Alpha-Beta Search](https://github.com/aimacode/aima-pseudocode/blob/master/md/Alpha-Beta-Search.md))
